            ...
            <div className="grid grid-cols-2 gap-4">
                {values.map((value) => (
                    <div key={value.title} className="p-4 bg-gray-100 rounded-2xl flex flex-col items-center">
                        <div className="text-3xl font-medium">{value.title}</div>
                        <div className="text-4xl font-bold mt-4">{value.performance} / {value.total}</div>
                        <div className="text-4xl font-bold mt-4">{value.percent} %</div>
                    </div>
                ))}
            </div>
        </div>
